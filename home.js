  ...
  const sendFile = useCallback(async () => {
    if (image && selectedFile) {
        ...
        try {
            ...
            console.error('Error uploading the image:', error); // Log the error for debugging
        ...
        >
          <Grid item xs={12}>
            <Card className={`${classes.imageCard} ${!image ? classes.imageCardEmpty : ''}`}>
              ...
              {isLoading && <Grid container direction="column" alignItems="center">
                <CircularProgress className={classes.loader} size={100} />
              </Grid>}
            </Card>
          </Grid>
          {image && <Grid item xs={12} className={classes.buttonGrid}>
